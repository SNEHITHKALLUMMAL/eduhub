    ...
    <div className="min-h-[calc(100vh-73px)] flex items-center justify-center px-4 py-12 bg-gradient-to-br from-slate-50 to-primary-50/30">
      <div className="max-w-md w-full glass p-8 rounded-3xl animate-in fade-in zoom-in duration-500">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 mt-2 font-medium">Join EduHub to start your learning journey</p>
        </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-slate-600 font-medium">
            ...
            <Link to="/login" className="text-primary-600 font-bold hover:text-primary-700 transition-colors hover:underline underline-offset-4">
              Login here
            </Link>
          </p>
        </div>
